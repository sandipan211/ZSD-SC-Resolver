...
def parse_args():
    ...
    parser.add_argument('--pretrain_regressor',default='',help="path to pretrain regressor ")
    parser.add_argument('--regressor_lamda',type=float,default='0.01',help="cyclic consistency loss weight ")
    parser.add_argument('--triplet_lamda',type=float,default='0.001',help="triplet loss weight")
    parser.add_argument('--tr_mu_dtilde',type=float,default='0.5',help="hyper_par for var marg")
    parser.add_argument('--tr_sigma_dtilde',type=float , default='0.5', help="hyper_par for var marg")
    opt = parser.parse_args()
    return opt
    #parser.add_argument('--tr_fxmargin',type=float,default='1.0',help="triplet fix margin")
