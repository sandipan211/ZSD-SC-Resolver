...
def print_map_summary(aps, results, dataset=None, dataset_name=None, ranges=None, recalls=None, split='65_15'):
    ...
    for i in range(num_scales):
        ...
        for ind in range(len(indexes)):
            ...
            for j in classes_inds:
                if num_gts[i, j] > 0:
                    row_data = [
                        ...
                        '{:.3f}'.format(precisions[i, j]), '{:.6f}'.format(aps[i, j])
                    ]
            ...
            table_data.append(['mean', '', '', '{:.3f}'.format(mean_recall), '', '{:.6f}'.format(mean_ap)])
            means_table.append(['mean', '', '', '{:.3f}'.format(mean_recall), '', '{:.6f}'.format(mean_ap)])
