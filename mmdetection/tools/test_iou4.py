...
def main():
    ...
    print("for IOU=0.4 ::")
    mean_ap, _ = eval(args.out, dataset,iou_thr=0.4, dataset_name=dataset_name, split=cfg.data.test.split)
    print(f'iou 0.4 mAP is :{mean_ap}')
    ...
    print("for IOU=0.5 ::")
    mean_ap1, _ = eval(args.out, dataset,iou_thr=0.5, dataset_name=dataset_name, split=cfg.data.test.split)
    print(f'iou 0.5 mAP is :{mean_ap1}')

    print("for IOU=0.6 ::")
    mean_ap2, _ = eval(args.out, dataset,iou_thr=0.6, dataset_name=dataset_name, split=cfg.data.test.split)
    print(f'iou 0.6 mAP is :{mean_ap2}')
