...
dir_name='coco_65_15_wgan_modeSeek_seen_cycSeenUnseen_tripletSeenUnseen_varMargin_try3'
path='/workspace/arijit_ug/sushil/zsd'
syn_weights = '/workspace/arijit_ug/sushil/zsd/checkpoints/ab_st_final/coco_65_15_wgan_modeSeek_seen_cycSeenUnseen_tripletSeenUnseen_varMargin_try3/classifier_best_latest.pth'
...
try:
    ...
    os.makedirs(f'/workspace/arijit_ug/sushil/zsd/checkpoints/ab_st_final/{dir_name}/det_results/coco_gzsd_{score_thr}')
...
det_results=mmcv.load(f'/workspace/arijit_ug/sushil/zsd/checkpoints/ab_st_final/{dir_name}/'+(dir_name)+'_gzsd_result.pkl')
#print(det_results[1])
# #print(det_results[-1])
# quit()
# gen_filenames = [
...
for idx, info in enumerate(img_infos):
    ...
    # result = det_results[start+idx]#inference_detector(model, img)
    # import pdb; pdb.set_trace()
    out_file = f"{path}/checkpoints/ab_st_final/{dir_name}/det_results/coco_gzsd_{score_thr}/{img.split('/')[-1]}"
